...
Первоначальная подготовительная база `PREP-00…PREP-07` была завершена. `PREP-08` добавлен как целевая процессная поправка до начала систематических исследований. Следующие шаги — первые реальные `USE`, первоначальный `research-plan.md` и затем работы класса `RSCH`.
