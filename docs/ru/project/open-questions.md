...
Исходные вопросы `Q-0001…Q-0012` перенесены из `PREP-00`. PREP-00 остаётся исторической контрольной точкой, а текущее состояние вопросов отслеживается здесь и в отдельных карточках.
...
Следующий свободный идентификатор: `Q-0013`.
